...
try {
const response = await fetch(`https://projectfypmanagmentapp.vercel.app/api/projects/${projectId}/collaborators`, {
    method: 'POST',
    headers: {
...
async function fetchProjects() {
    ...
    const response = await fetch("https://projectfypmanagmentapp.vercel.app/api/projectsDisplay/userfromprojects", {
        method: "GET",
        headers: {
    ...
    for (const project of projects) {
        const taskSummaryResponse = await fetch(`https://projectfypmanagmentapp.vercel.app/api/getCompletedTasksOfOneProject/${project._id}`, {
            method: "GET",
            headers: {
                email: email,
                password: password,
...
try {
const response = await fetch(`https://projectfypmanagmentapp.vercel.app/api/reports/project/${projectId}`, {
    method: 'GET',
    headers: {
        'Content-Type': 'application/json',
        email: email,
...
async function addProject() {
    ...
    await fetch("https://projectfypmanagmentapp.vercel.app/api/projects", {
        method: "POST",
        headers: {
            "Content-Type": "application/json",
            email: email,
...
async function fetchUserProjects() {
    ...
    const response = await fetch("https://projectfypmanagmentapp.vercel.app/api/projects/user-projects", {
        method: "GET",
        headers: {
            "userId": userId,
           email:email,
...
try {
const response = await fetch(`https://projectfypmanagmentapp.vercel.app/api/projects/${id}`, {
    method: "DELETE",
    headers: {
        email: email,
        password: password
